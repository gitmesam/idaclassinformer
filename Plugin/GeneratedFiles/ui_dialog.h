...
public:
    ...
    void retranslateUi(QDialog *MainCIDialog)
    {
        ...
        checkBox3->setText(QApplication::translate("MainCIDialog", "Audio on completion", Q_NULLPTR));
        ...
        versionLabel->setText(QApplication::translate("MainCIDialog", "Version: 2.5\n"
